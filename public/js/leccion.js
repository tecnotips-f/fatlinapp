...
const LEC_TOPICS = [
  ...
  { tema: 'Protocolo Fatlin-IAG: IA en evaluación PACIE',    src: 'asomtv.org',      foco: 'integración de inteligencia artificial generativa en entornos PACIE' },
...
const LECCIONES_OFFLINE = [
  ...
  },
  {
    ...
    tema: 'Protocolo Fatlin-IAG: evaluación con Inteligencia Artificial',
    pags: [
      { h: 'intro', c: [
        { t: 'p', x: 'El <b>Protocolo Fatlin-IAG</b>, avalado por ASOMTV y Planeta FATLA, integra la Inteligencia Artificial Generativa como motor de evaluación continua y personalizada en entornos PACIE.' },
        ...
        { t: 'tags', x: [{ l: 'Fatlin-IAG', b: 'rgba(240,192,64,.1)', c: '#f0c040' }, { l: 'ASOMTV', b: 'rgba(251,113,133,.1)', c: '#fb7185' }] }
      ]},
      ...
      { h: 'cierre', c: [
        { t: 'hl', x: 'Fatlin-IAG genera lecciones y preguntas desde fuentes oficiales PACIE en tiempo real — cada sesión es única y actualizada.' },
        { t: 'nota', fuente: 'asomtv.org', sec: 'Protocolo Fatlin-IAG · asomtv.org' }
      ]}
    ]
  },
  {
...
/** Muestra los botones de navegación, oculta el botón "Ver lección" */
function _showNav() {
  const fab = document.getElementById('lec-fab');
  const nav = document.getElementById('lec-nav-btns');
  if (fab) fab.classList.add('hidden');
  if (nav) nav.classList.add('visible');
}

/** Muestra el botón "Ver lección", oculta los de navegación */
function _showFab() {
  const fab = document.getElementById('lec-fab');
  const nav = document.getElementById('lec-nav-btns');
