...
const LANG = {
  es: {
    ...
    diploma_org:     'Fatlin AI · Tecnopedagogigo',
  ...
  en: {
    ...
    diploma_org:     'Fatlin AI · Technopedagogical',
...
const PACIE_SOURCE_GROUPS = {
  fatla: {
    ...
    urls: [
      ...
      "https://becas.fatla.org/mod/page/view.php?id=28",
      "https://becas.fatla.org/mod/page/view.php?id=51",
  ...
  pacie: {
    ...
    urls: [
      ...
      "https://www.pacie.education/portal/mod/page/view.php?id=9",
      "https://www.pacie.education/portal/mod/page/view.php?id=11",
      "https://www.pacie.education/portal/mod/page/view.php?id=12",
      "https://www.pacie.education/portal/mod/page/view.php?id=13",
      "https://www.pacie.education/portal/mod/page/view.php?id=14",
      "https://www.pacie.education/portal/mod/page/view.php?id=15",
      ...
      "https://www.pacie.education/portal/mod/page/view.php?id=19",
      ...
      "https://www.pacie.education/portal/mod/page/view.php?id=23",
      "https://www.pacie.education/portal/mod/page/view.php?id=18",
      "https://www.pacie.education/portal/mod/page/view.php?id=20",
      "https://www.pacie.education/portal/mod/page/view.php?id=26",
      "https://www.pacie.education/portal/mod/page/view.php?id=27",
      "https://www.pacie.education/portal/mod/page/view.php?id=28",
      "https://www.pacie.education/portal/mod/page/view.php?id=18",
      "https://www.pacie.education/portal/mod/page/view.php?id=21",
      "https://www.pacie.education/portal/mod/page/view.php?id=29",
      "https://www.pacie.education/portal/mod/page/view.php?id=30"
    ]
  },
  asomtv: {
    label: "ASOMTV",
...
const POOL_REFRESH_THRESH  = 0.60;          // recargar al consumir 60% del pool
...
function _promptSeed(level){
  ...
  const seeds = [
    ...
    'enfócate en INTERPRETACIONES INCORRECTAS que distorsionen del concepto real',
...
const certData = {
  ...
  // Causa del bloqueo: usaba if(false){} para evitar SyntaxError por /* */ anidados.
  ...
  // PERSISTENCIA EN FIREBASE (LEGACY)
  (async () => {
    try {
      await setDoc(
